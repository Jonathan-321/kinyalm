...
ADAPTER_RUNTIME_DIR="${KINYALM_GEMMA4_TARGETED_DIR:-$HOME/.cache/kinyalm/gemma4-12b-continuation-targeted-lr2e6}"
...
ADAPTER_REPO="kinyalm/kinyalm-gemma-4-12b-continuation-targeted-lr2e6"
ADAPTER_REVISION="274504f7bcd029230ea6dfe04bc251964642bbda"
