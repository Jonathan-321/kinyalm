...
ADAPTER_RUNTIME_DIR="${KINYALM_GEMMA4_ADAPTER_DIR:-$HOME/.cache/kinyalm/gemma4-12b-corrected-control-adapter}"
...
ADAPTER_REPO="${KINYALM_GEMMA4_ADAPTER_REPO:-kinyalm/kinyalm-gemma-4-12b-corrected-control}"
ADAPTER_REVISION="${KINYALM_GEMMA4_ADAPTER_REVISION:-fb911c9b842c2e49cfb1705cde28be0637bf8d68}"
