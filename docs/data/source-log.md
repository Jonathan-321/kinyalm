...
| --- | --- | --- | --- | --- | --- | --- | --- |
| DigitalUmuganda Kinyarwanda TTS dataset | https://huggingface.co/datasets/DigitalUmuganda/kinyarwanda-tts-dataset | Kinyarwanda sentence text | KILM tokenizer analysis and small LM baseline | dataset LICENSE fetched as `cc0-1.0` | Tessy Mugisha | approved | KILM imports the 4,000 sentence CSV into local ignored text. Current full baseline uses 3,922 prepared lines with 3,530 train / 392 validation lines. |
| DigitalUmuganda Kinyarwanda-English MT dataset | https://huggingface.co/datasets/DigitalUmuganda/kinyarwanda-english-machine-translation-dataset | Parallel text | Kinyarwanda-side tokenizer/LM corpus, bilingual examples, possible evaluation | visible `cc-by-4.0` | Tessy Mugisha | approved | KILM can import the Kinyarwanda side. Preserve attribution and document translation/domain bias in data cards. |
